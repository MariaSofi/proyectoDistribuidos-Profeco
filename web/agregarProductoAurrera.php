    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="wishlistAurrera.php">WishList</a>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="visualizarReporteAurrera">Reporte</a>
          </li>
  ...
  <div class="row">
    ...
    <div class="col-lg-3">
      ...
      <div class="list-group">
        ...
        <a href="Aurrera.php" class="list-group-item active">Aurrera</a>
...
<table class = "table">
<form name="form" action="agregar2.php" method="post">
  ...
  <tr>
    ...
    <tr>
		...
		<td><input type="text" name="supermercado" value="Aurrera" required="required" readonly></td>
    </tr>
    <tr>
