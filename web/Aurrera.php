    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
          <a class="nav-link" href="visualizarReporteAurrera.php">Reportes</a>
          </li>
...
<a href="reporteAurrera.php" class="get-started-btn"  >Mandar Reporte</a>
...
<?php 
    ...
    ?>
     ...
     <td><?php echo $row['descripcion'];?></td>
      ...
      <td><a href='detalleAurrera.php?id=<?php echo $row['id'];?>'>Ver</a></td>
		</tr>
    <?php  
	}
?>
